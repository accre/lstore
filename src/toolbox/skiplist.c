...
skiplist_key_t *sl_passthru_dup(skiplist_key_t *key) { return(key); }
...
int remove_skiplist(skiplist_t *sl, skiplist_key_t *key, skiplist_data_t *data)
{
  ...
  if (cmp != 0) { return(1); }  //** No match so return
