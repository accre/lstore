...
void opque_set_failure_mode(opque_t *q, int value) { q->op.base.failure_mode = value; }
int opque_get_failure_mode(opque_t *q) { return(q->op.base.failure_mode); }
...
void _opque_start_execution(opque_t *que)
{
  ...
  if (gop->base.started_execution != 0) { return; }
...
int compare_ops(const void *arg1, const void *arg2)
{
  ...
  cb = (callback_t *)arg1; gop = (op_generic_t *)cb->priv; c1 = &(gop->op->cmd);
  cb = (callback_t *)arg2; gop = (op_generic_t *)cb->priv; c2 = &(gop->op->cmd);
