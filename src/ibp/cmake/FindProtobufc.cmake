...
ELSE (PROTOBUF_LIBRARY AND PROTOBUF_INCLUDE_DIR AND PROTOBUF_PROTOC_EXECUTABLE)
  ...
  FIND_PATH(PROTOBUF_INCLUDE_DIR google/protobuf-c/protobuf-c.h
    /usr/include/
    $ENV{HOME}/include
	
  )

  FIND_LIBRARY(PROTOBUF_LIBRARY NAMES protobuf-c
    PATHS
    ${GNUWIN32_DIR}/lib
    $ENV{HOME}/lib
  )

  FIND_PROGRAM(PROTOBUF_PROTOC_EXECUTABLE protoc-c)
...
IF (PROTOBUF_FOUND)
  ...
  FUNCTION(WRAP_PROTO VAR)
	...
	SET_SOURCE_FILES_PROPERTIES( "${CMAKE_CURRENT_BINARY_DIR}/${FIL_WE}.pb-c.c" PROPERTIES LANGUAGE C )
