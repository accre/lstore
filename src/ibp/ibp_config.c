...
void ibp_set_min_depot_threads(ibp_context_t *ic, int n) 
   { ic->min_threads = n; ic->pc->min_threads = n; change_all_hportal_conn(ic->pc, ic->min_threads, ic->max_threads); }
...
void ibp_set_max_depot_threads(ibp_context_t *ic, int n) 
   { ic->max_threads = n; ic->pc->max_threads = n; change_all_hportal_conn(ic->pc, ic->min_threads, ic->max_threads); }
